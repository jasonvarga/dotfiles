return {
  ...
  },
  {
    name = 'Multi',
    cells = {
      { '0,0 4x20',   '0,0 7x20',   '0,8 11x12',  '0,10 11x10', '0,12 11x8' },
      { '4,0 11x20',  '7,0 10x20',  '0,0 11x8',   '0,0 11x10',  '0,0 11x12' },
      { '15,0 15x20', '17,0 13x20', '11,0 19x20', '11,0 19x20', '11,0 19x20' },
    },
    apps = {
        Arc = { cell = 2, open = true },
        Ray = { cell = 1, open = true },
